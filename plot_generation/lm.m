function [p,X2,sigma_p,sigma_y,corr,R_sq,cvg_hst] = lm(func,p,time,data,weight,dp,p_min,p_max,c,fit_start,fit_end, MaxIter)
...
prnt = 2;		% >1 intermediate results; >2 plots
...
while ( ~stop & iteration <= MaxIter )		% --- Main Loop
    %waitbar(iteration/MaxIter, f, sprintf('Progress: %d %%', floor(iteration/MaxIter*100)));
    %pause(0.1)
