function jox_cellular_kn(jobind, temperature, savepath)
...
load(join([analyzefolder,'/',savepath, '/', name,'_int_fitted_kn_in_rings.mat'], ''));
    ...
    kox(l,k)=(bound_ratio_mito_nadh(l,k)-kn_cell(l));
...
save(join([analyzefolder, '/', savepath, '/', name,'_jox_in_rings_cellular_kn.mat'], ''),'irr_mito_cell_dist_mat_mean','dist_mito_cell_dist_mat_mean','bound_ratio_mito_nadh','long_mito_nadh','short_mito_nadh','nadhf','kox','jox');
