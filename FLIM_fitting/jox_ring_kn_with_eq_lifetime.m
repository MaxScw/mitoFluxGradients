function jox_ring_kn_with_eq_lifetime(jobind)
...
load('NADH_cal.mat')
load('ocr_conv_new.mat')
load([analyzefolder,'/',name,'_int_fitted_kn_in_rings.mat']);
    ...
    long_ring(l,k)=p_lm_mito_4{l,k}(3);
...
save([name,'_jox_in_rings_ring_kn_with_lifetime.mat'],'irr_mito_cell_dist_mat_mean','dist_mito_cell_dist_mat_mean','bound_ratio_mito_nadh','long_mito_nadh','short_mito_nadh','nadhf','kox','jox','kn_ring','long_ring');
