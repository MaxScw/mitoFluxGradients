function TotalInts = IntensitymatrixTiffs(path,WrVal,Ch2Bool,Bit16Bool,PlotBool)
...
if ~exist('PlotBool') PlotBool = 1; end
Dsdt=dir([path '\*.sdt']);
sdtL = length(Dsdt);
block_1=1;
block_2=2;
...
if isdir(path)
    save([path '\TotalIntensities.mat'],'TotalInts','TotalPhots','numscans','IRfacts','sdtendtimes','SDTfilenames');
